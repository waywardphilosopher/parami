...
tags:
  - Ethics
description: Getting started thinking through ethics
---
## **Welcome back**
...
3. How does the difficulty of this problem relate to the problem raised in the Euthyphro? 
...
- Or perhaps, ethics is about **caring** for others. How do we build a culture of care? Should we care for each other equally, or should care be differentiated according to our different relationships? This is called ++***care ethics***++.
...
- Finally, perhaps **religion** has something to do with ethics. For many, religion and ethics are inseparable. This raises all kinds of interesting questions. For example: maybe ethical rules are not worked out by human beings, but are *revealed* to us. So what role does religion have in deciding ethics? This will be our final approach, looking at ++***religious ethics***++.
...
Let’s take this Myanmar-themed ethical dilemma from the University of Texas at Austin. It is about amber sourced from Myanmar. Read through, and discussion question 1 in the questions section. 

What other ethical approaches other than deontology and utilitarianism could help inform your discussions of this case study? 
...
We'll discuss this case study in groups.

1. What is the right thing to do in this case?
2. How do we ***know*** what the right thing to do is?
3. What ***arguments*** can we use to persuade others what the right thing to do is?

## **Homework**

Next time, we’re going to start by talking in more depth about deontological ethics: in other words, rule-based ethics.
...
On the Canvas discussion board, I want you to share the following. You must respond to both of these to get the participation grade.
